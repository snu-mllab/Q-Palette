...
class LlamaMLP(nn.Module):
    ...
    def __init__(self, config, layer_idx):
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_gate' not in config.quip_params['skip_list']:
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_up' not in config.quip_params['skip_list']:
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_down' not in config.quip_params['skip_list']:
...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_q' not in config.quip_params['skip_list']:
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_k' not in config.quip_params['skip_list']:
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_v' not in config.quip_params['skip_list']:
        ...
        if hasattr(config, 'quip_params') and f'{layer_idx}_o' not in config.quip_params['skip_list']:
